...
import karaoke_queue.database.fuzzy_query as fuzzy_query
...
def search_song(song_name: str) -> dict:
    ...
    songs = fuzzy_query.get_best_matched_songs(song_name, limit=10)

    return {
        # TODO return more context to songs than just the title
        "songs": [song.to_transmit for song in songs],
        "links": {
            # TODO
        }
    }
